# Fields show incorrect Data Validation # 
...
Please see the screenshot titled. "Student Registration Form Data Validation -- Student form required fields validation and assert CSS border colour (failed)" 
